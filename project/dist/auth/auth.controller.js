...
const registritor_dto_1 = require("./moduls/registritor.dto");
const jwt_1 = require("@nestjs/jwt");
const auth_guard_1 = require("./auth.guard");
const auth_service_1 = require("./auth.service");
const updateUser_dto_1 = require("../user/entity/updateUser.dto");
let AuthController = class AuthController {
    ...
    async login(email, password, res) {
        ...
        return Object.assign(Object.assign({}, user), { token: jwt });
    }
    async user(request) {
        try {
...
__decorate([
    ...
    __metadata("design:paramtypes", [registritor_dto_1.RegistritorDto]),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AuthController.prototype, "updata", null);
__decorate([
    (0, common_1.UseGuards)(auth_guard_1.AuthGuard),
    ...
    __metadata("design:returntype", Promise)
], AuthController.prototype, "uppassword", null);
__decorate([
    (0, common_1.UseGuards)(auth_guard_1.AuthGuard),
